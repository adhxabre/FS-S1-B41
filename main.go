...
func blogs(w http.ResponseWriter, r *http.Request) {
	...
	rows, _ := connection.Conn.Query(context.Background(), "SELECT blog.id, title, image, content, post_at, name FROM blog LEFT JOIN users ON blog.author_id = users.id ORDER BY id DESC")
